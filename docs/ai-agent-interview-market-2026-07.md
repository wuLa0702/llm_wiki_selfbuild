...
created: 2026-07-27
status: 来自用户搜索整理
related: agent-architecture-diagrams.md
---

# 2026年6月→7月 AI Agent 面试行情与招聘变化

> 关联文档：[Agent 架构图 — 当前节点与未来拓展](./agent-architecture-diagrams.md)  
...
> 以下关键技术点在本项目的 `agent-architecture-diagrams.md` 中有详细图解和代码逻辑。

| 面试考点 | 对应文档位置 |
|:---------|:------------|
| LangGraph StateGraph 节点与边 | `agent-architecture-diagrams.md` §1.1–1.2 |
| MemorySaver + SQLite 混合持久化 | `agent-architecture-diagrams.md` §2.1–2.4 |
| Human-in-the-Loop 审批流程 | `agent-architecture-diagrams.md` §1.5 |
| 对话摘要压缩 (summarizer) | `agent-architecture-diagrams.md` §1.6 |
| 工具节点设计 (search_wiki / read_page) | `agent-architecture-diagrams.md` §三 |
| 多智能体拓展规划 (supervisor/worker) | `agent-architecture-diagrams.md` §4.2–4.4 |
| 常量体系 (100+ 常量) | `agent-architecture-diagrams.md` §五 |
| 测试覆盖 (149 个测试) | `agent-architecture-diagrams.md` §六 |
