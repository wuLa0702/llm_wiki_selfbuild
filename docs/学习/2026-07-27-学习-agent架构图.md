...
> | 版本 | 日期 | 具体改动 |
> |------|------|---------|
> | v1 | 2026-08-12 | 初版：自 `docs/学习/2026-07-27-学习-agent架构图.md` 迁移（仅补规范头，正文未改） |
...
- [版本标注规则](#版本标注规则)
- [一、当前 StateGraph 节点与边](#一、当前-StateGraph-节点与边)
- [二、多轮会话隔离（MemorySaver + SQLite 混合方案）](#二、多轮会话隔离MemorySaver-+-SQLite-混合方案)
- [三、工具节点详情](#三、工具节点详情)
- [四、未来拓展节点](#四、未来拓展节点)
- [五、常量体系总览](#五、常量体系总览)
- [六、文件全景](#六、文件全景)
...
> 关联文档：[2026年7月 AI Agent 面试行情与招聘变化](./学习/2026-07-27-学习-AI-agent面试市场.md)
...
> 未变更，逻辑与 `docs/学习/2026-07-27-学习-agent架构图.md` v4 一致。
