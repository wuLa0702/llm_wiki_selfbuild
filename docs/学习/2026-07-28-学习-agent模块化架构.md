...
> | 版本 | 日期 | 具体改动 |
> |------|------|---------|
> | v1 | 2026-08-12 | 初版：自 `docs/学习/2026-07-28-学习-agent模块化架构.md` 迁移（仅补规范头，正文未改） |
...
- [设计原则](#设计原则)
- [一、模块总览与数据流](#一、模块总览与数据流)
- [二、Perception（感知模块）](#二、Perception感知模块)
- [三、Planning（规划模块）](#三、Planning规划模块)
- [四、Memory（记忆模块）](#四、Memory记忆模块)
- [五、Action（执行模块）](#五、Action执行模块)
- [六、重构后的完整文件树](#六、重构后的完整文件树)
- [七、迁移路径](#七、迁移路径)
- [八、不变的部分](#八、不变的部分)
